...
Also for the purpose of the demo, I used some simpler security for maintaining credentials. For production, I would use some kind of encryption based of the company.
## Project Structure
